...
$nama = $email = $username = $nomorTelepon = $role = $foto = '';
...
// Set variabel untuk form dengan data dari database
$nama = $data['nama_222271'] ?? '';
$email = $data['email_222271'] ?? '';
$username = $data['username_222271'] ?? '';
$nomorTelepon = $data['nomorTelepon_222271'] ?? '';
$role = $data['role_222271'] ?? '';
$foto = $data['foto_222271'] ?? '';
                            ...
                            <div class="card shadow-lg border-0">
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <button type="button" class="btn btn-dark" onclick="window.location.href='dataUser.php'">Kembali</button>
                                    </div>
                                </form>
                            </div>
                        </div>
