...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="main/css/styles.css">



    <!-- Font -->
    <link rel="stylesheet" href="main/font/fonts.css">

    <!-- Icon -->
    <link rel="stylesheet" href="main/icon/style.css">

    <!-- Favicon and Touch Icons  -->
    <link rel="shortcut icon" href="main/main/images/favicon.png">
    <link rel="apple-touch-icon-precomposed" href="main/main/images/favicon.png">
...
<body>
                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="index.html" id="site-logo-inner">
                            <img class="" id="logo_header" alt="" src="main/main/images/logo/logo.svg" data-light="main/main/images/logo/logo.svg" data-dark="main/images/logo/logo-white.svg">
                        </a>
                                ...
                                <ul class="">
                                    ...
                                    <<li class="menu-item">
                                        <a href="#">
                                            ...
                                            <div class="text">Penghuni Kost</div>
                                        </a>
                                        </li>
                                        ...
                                        <li class="menu-item has-children">
                                            <a href="javascript:void(0);" class="menu-item-button">
                                                ...
                                                <div class="text">Transaksi Pembayaran</div>
                                            </a>
                                            <ul class="sub-menu">
                                                <li class="sub-menu-item">
                                                    <a href="#" class="">
                                        ...
                                        <li class="menu-item">
                                            <a href="#" class="">
                                                ...
                                                <div class="text">Keluar Dari Dhasboard</div>
                                            </a>
                                        </li>
                                        <li class="menu-item">
                                            <a href="index.html" class="">
                    ...
                    <div class="header-dashboard">
                        <div class="wrap">
                            <div class="header-left">
                                <a href="index.html">
                                    <img class="" id="logo_header_mobile" alt="" src="main/images/logo/logo.svg" data-light="main/images/logo/logo.svg" data-dark="main/images/logo/logo-white.svg">
                                </a>
                                <div class="button-show-hide">
                                    <i class="icon-chevron-left"></i>
                                </div>
                                                ...
                                                <ul>
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="main/images/products/product-1.jpg" alt="">
                                                        </div>
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="main/images/products/product-2.jpg" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                    ...
                                                    <li class="product-item gap14">
                                                        <div class="image no-bg">
                                                            <img src="main/images/products/product-3.jpg" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                        ...
                                        <ul class="">
                                            ...
                                            <li>
                                                <ul>
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="main/images/products/product-4.jpg" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="main/images/products/product-5.jpg" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="main/images/products/product-6.jpg" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                    ...
                                                    <li class="product-item gap14">
                                                        <div class="image no-bg">
                                                            <img src="main/images/products/product-7.jpg" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="#" class="body-text">Jersey thong body</a>
                            ...
                            <div class="header-grid">
                                <div class="header-item country">
                                    <select class="image-select no-text">
                                        <option data-thumbnail="main/images/country/1.png">ENG</option>
                                        <option data-thumbnail="main/images/country/9.png">VIE</option>
                                    </select>
                                </div>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton1">
                                            ...
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    <div class="image">
                                                        <img src="main/images/customers/customer-1.jpg" alt="">
                                                    </div>
                                                    <div class="flex-grow">
                                            ...
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    <div class="image">
                                                        <img src="main/images/customers/customer-2.jpg" alt="">
                                                    </div>
                                                    <div class="flex-grow">
                                                        <div class="flex items-center justify-between">
                                            ...
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    <div class="image">
                                                        <img src="main/images/customers/customer-3.jpg" alt="">
                                                    </div>
                                                    <div class="flex-grow">
                                                        <div class="flex items-center justify-between">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton4">
                                            ...
                                            <li>
                                                <ul class="list-apps">
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="main/images/apps/item-1.png" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="main/images/apps/item-2.png" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="main/images/apps/item-3.png" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="main/images/apps/item-4.png" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="main/images/apps/item-5.png" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="main/images/apps/item-6.png" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="main/images/apps/item-7.png" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="main/images/apps/item-8.png" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="main/images/apps/item-9.png" alt="">
                                                        </div>
                                                        <a href="#">
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                                            <span class="header-user wg-user">
                                                <span class="image">
                                                    <img src="main/images/avatar/user-1.png" alt="">
                                                </span>
                                    ...
                                    <div class="wg-box">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <div class="dropdown default style-box">
                                                <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <a href="#" class="view-all">Yearly<i class="icon-chevron-down"></i></a>
                                                </button>
                                    ...
                                    <div class="flex gap20 flex-wrap-mobile">
                                        ...
                                        <div class="wg-box w-half">
                                            <div class="flex items-center justify-between">
                                                ...
                                                <div class="dropdown default style-box">
                                                    <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                        <a href="#" class="view-all">Weekly<i class="icon-chevron-down"></i></a>
                                                    </button>
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a href="javascript:void(0);">Yearly</a>
    ...
    <script src="main/js/zoom.js"></script>
    <script src="main/js/morris.min.js"></script>
    <script src="main/js/raphael.min.js"></script>
    <script src="main/js/morris.js"></script>
    <script src="main/js/jvectormap.min.js"></script>
    <script src="main/js/jvectormap-us-lcc.js"></script>
    <script src="main/js/jvectormap-data.js"></script>
    <script src="main/js/jvectormap.js"></script>
    <script src="main/js/apexcharts.js"></script>
    <script src="main/js/line-chart-1.js"></script>
    <script src="main/js/line-chart-2.js"></script>
    <script src="main/js/line-chart-3.js"></script>
    <script src="main/js/line-chart-4.js"></script>
    <script src="main/js/line-chart-5.js"></script>
    <script src="main/js/line-chart-6.js"></script>
    <script src="main/js/line-chart-7.js"></script>
    <script src="main/js/switcher.js"></script>
    <script defer src="main/js/theme-settings.js"></script>
